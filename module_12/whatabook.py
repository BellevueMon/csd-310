...
def show_menu():
  ...
  try:
    choice = int(input('      <Example enter: 1 to view the available books>: '))
    return choice
  except ValueError:
...
#Function definition for showing available books
...
#Function definition for showing store locations
...
#Function definition for Validating Users
def validate_user():
    ...
    try:
        ...
        """ Change from quitting program to revalidate """
        if uidCasted < 1 or uidCasted > 3:
            print("Apologies, that's not a valid customer number, please try again...")
            validate_user()
        else:
            return uidCasted

    except ValueError:
        print("Hmm thats an invalid number, please try again...")
        validate_user()
        

#Function definition for Show Accocunt menu
def show_account_menu():
    ...
    try:
        ...
        account_option = int(input('        <Enter: 1 for wishlist>: '))
...
#Function definition for Wishlist
...
#Function definition for adding books to wishlist
...
try:
    ...
    db = mysql.connector.connect(**config) # Connecting to the sql config above
